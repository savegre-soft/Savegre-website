      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {[
            ...
            <div key={label} className="bg-neutral-900 border border-neutral-800 p-6 flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            {values.map((v, i) => (
              <div key={v.title} className="bg-neutral-900 border border-neutral-800 p-6 flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <span className="text-xs text-neutral-600 font-medium">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <span className="text-xs tracking-widest uppercase text-neutral-500">{v.title}</span>
                </div>
